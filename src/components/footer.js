const footer = ()=>{
    return ` <div id="cart_footer">
    <div>
    <div id="mobile_img">
        <img src="https://assets.pharmeasy.in/web-assets/dist/34a16ae8.jpg" />
    </div>
    <div id="buttons">
        <p>Download the App for Free</p>
        <div>
        <button><ion-icon name="logo-google-playstore"></ion-icon>Google Play</button>
        <button><ion-icon name="logo-apple"></ion-icon>App Store</button>
    </div>
    </div>
    </div>
    ...
    <div id="footer_center">
        ...
        <div id="footer_img" >
            ...
            <div id="footer_box">
                ...
                <img src="https://assets.pharmeasy.in/web-assets/dist/6e09c713.svg" />
